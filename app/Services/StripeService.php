...
class StripeService
{
    ...
    public function handleSubscription(Request $request) {
        ...
        return redirect()->route('subscribe.show')->withErrors('We were unable to activate the subscription');
    }
    ...
    public function createSubscription($customer_id, $paymentMethod, $priceId) {
